...
(function($, undefined) {
	...
	jPlayerPlaylist = function(cssSelector, playlist, options) {
		...
		// Turn the empty but styled list items into stylesheet statements
		var positioning = "position: absolute; top: 0px;",
			baseItemStyle = $(this.cssSelector.playlist + " .playlistbase").attr("style").replace(positioning, ""),
			currentItemStyle = $(this.cssSelector.playlist + " .playlistcurrent").attr("style").replace(positioning, ""),
			hoverItemStyle = $(this.cssSelector.playlist + " .playlisthover").attr("style").replace(positioning, "");
		$("head").append("<style>.jp-playlist-item{" + baseItemStyle + "}li .jp-playlist-current{" + currentItemStyle + "}.jp-playlist-item:hover{" + hoverItemStyle + "}</style>");
